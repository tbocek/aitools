...
func TestTheSameInstantIsDrawnInTheSameColumn(t *testing.T) {
	...
	// the loud part of each lane, in px. Read across the lane's middle row,
	// which a column of any height at all covers: what separates sound from
	// silence there is the ink, not the height -- the quiet stretches have the
	// centre line under them, and the centre line is a third of the blue over
	// dark ground, well short of what isBlue will take.
