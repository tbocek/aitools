...
//
//	AUTOCUT_LIVE=1 go test -run TestStep3PipelineLive -v -timeout 60m
...
func TestStep3PipelineLive(t *testing.T) {
	...
	if err := a.step3(videos, audios, 1); err != nil { // 1 = the whole progress bar
