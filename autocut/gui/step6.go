...
// Step 6: Publish. The two things a finished video still needs before anyone
...
// pickImage opens the file chooser. An empty start folder means the one step 1
...
// publishShots is every frame step 1 extracted, on the session's clock. The
