...
// narrator -- it is the voice step 4 speaks in -- and a first session should
...
// and two rows claiming to be narrator 1 would leave step 4 picking one of them
